...
* **Same frame painting.** Content changes (layout changes, style changes, animations, etc.) should appear in the same frame whether painted using the HTML-in-Canvas APIs or through regular rendering.
